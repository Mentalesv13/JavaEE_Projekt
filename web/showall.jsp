               ...
               for(int i=0;i<list.size();i++){
                   ...
                   <div class="question-panel">
                       <div class="question">
                           ...
                           <a href="adm-page.jsp?pgprt=9&qedt=<%=question.getQuestionId()%>&coursename=<%=request.getParameter("coursename")%>&label=<%=i+1 %>">
                               <div class="edit-btn" style="position: absolute;right: 100px;top: -20px;">edit</div></a>

                           <a href="controller.jsp?page=questions&operation=delQuestion&qid=<%=question.getQuestionId()%>&coursename=<%=request.getParameter("coursename")%>"
